                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form method="POST" action="{{ route('register') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="no_hp" placeholder="{{ __('Ho HP') }}" value="{{ old('no_hp') }}" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="alamat" placeholder="{{ __('Alamat') }}" value="{{ old('alamat') }}" required>
                                    </div>
                                    <div class="form-group">
                                        <select class="form-control rounded" id="jenis_kelamin" name="jenis_kelamin">
