...
<head>
    ...
    <link href="{{ asset('vendor/bootstrap/css/dataTables.bootstrap5.min.css') }}" rel="stylesheet">
    <link href="{{ asset('vendor/bootstrap/css/responsive.dataTables.min.css') }}" rel="stylesheet">
    <link href="{{ asset('vendor/bootstrap/css/rowReorder.dataTables.min.css') }}" rel="stylesheet">
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <hr class="sidebar-divider" style="color: aliceblue">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTransaction" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{ route('product.transaction') }}">Data Transaksi</a>
                </div>
            </div>
        </li>
        ...
        <!-- Divider -->
        <hr class="sidebar-divider d-none d-md-block" style="color: aliceblue">
...
{{-- datatables js --}}
<script src="{{ asset('vendor/bootstrap/js/dataTables.bootstrap5.min.js') }}"></script>
{{-- datatables responsive js --}}
<script src="{{ asset('vendor/bootstrap/js/dataTables.responsive.min.js') }}"></script>
{{-- datatables row order js --}}
<script src="{{ asset('vendor/bootstrap/js/dataTables.rowReorder.min.js') }}"></script>
{{-- jquery datatables --}}
<script src="{{ asset('vendor/bootstrap/js/jquery.dataTables.min.js') }}"></script>
